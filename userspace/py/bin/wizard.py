...
pages = [
    ...
    (f"\n<img src=\"/usr/share/icons/48/utilities-terminal.png\"></img>\nToaruOS aims to provide a Unix-like environment. You can find familiar command-line tools by opening a terminal. Application shortcuts on the desktop, as well as files in the file browser, are opened with a single click. You can also find more applications in the Applications menu.",[HintHole(70.5,80.5,50),HintArrow(110,120,-135)]),
