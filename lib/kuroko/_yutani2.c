...
#define TYPE(type) krk_attachNamedValue(&Message->methods, "MSG_" #type, INTEGER_VAL(YUTANI_MSG_ ## type))
	...
	TYPE(WINDOW_MOVE_RELATIVE); TYPE(WINDOW_SET_PARENT);
	TYPE(WINDOW_TILE); TYPE(WINDOW_SET_BLUR); TYPE(WINDOW_ROTATE);
...
#define MOUSE_EVENT_CONST(n) krk_attachNamedValue(&Message_WindowMouseEvent->methods, #n, INTEGER_VAL(YUTANI_ ## n))
	MOUSE_EVENT_CONST(MOUSE_EVENT_CLICK);
	MOUSE_EVENT_CONST(MOUSE_EVENT_DRAG);
	MOUSE_EVENT_CONST(MOUSE_EVENT_RAISE);
	MOUSE_EVENT_CONST(MOUSE_EVENT_DOWN);
	MOUSE_EVENT_CONST(MOUSE_EVENT_MOVE);
	MOUSE_EVENT_CONST(MOUSE_EVENT_LEAVE);
	MOUSE_EVENT_CONST(MOUSE_EVENT_ENTER);
	MOUSE_EVENT_CONST(MOUSE_EVENT_TYPE_RELATIVE);
	MOUSE_EVENT_CONST(MOUSE_EVENT_TYPE_ABSOLUTE);
	MOUSE_EVENT_CONST(MOUSE_BUTTON_LEFT);
	MOUSE_EVENT_CONST(MOUSE_BUTTON_RIGHT);
	MOUSE_EVENT_CONST(MOUSE_BUTTON_MIDDLE);
	MOUSE_EVENT_CONST(MOUSE_SCROLL_UP);
	MOUSE_EVENT_CONST(MOUSE_SCROLL_DOWN);
	MOUSE_EVENT_CONST(MOUSE_STATE_NORMAL);
	MOUSE_EVENT_CONST(MOUSE_STATE_MOVING);
	MOUSE_EVENT_CONST(MOUSE_STATE_DRAGGING);
	MOUSE_EVENT_CONST(MOUSE_STATE_RESIZING);
	MOUSE_EVENT_CONST(MOUSE_STATE_ROTATING);
#undef MOUSE_EVENT_CONST
...
#define KEY_EVENT_CONST(n) krk_attachNamedValue(&Message_KeyEvent->methods, #n, INTEGER_VAL(YUTANI_ ## n))
	KEY_EVENT_CONST(KEY_MODIFIER_LEFT_CTRL);
	KEY_EVENT_CONST(KEY_MODIFIER_LEFT_SHIFT);
	KEY_EVENT_CONST(KEY_MODIFIER_LEFT_ALT);
	KEY_EVENT_CONST(KEY_MODIFIER_LEFT_SUPER);
	KEY_EVENT_CONST(KEY_MODIFIER_RIGHT_CTRL);
	KEY_EVENT_CONST(KEY_MODIFIER_RIGHT_SHIFT);
	KEY_EVENT_CONST(KEY_MODIFIER_RIGHT_ALT);
	KEY_EVENT_CONST(KEY_MODIFIER_RIGHT_SUPER);
	KEY_EVENT_CONST(KEY_MODIFIER_CTRL);
	KEY_EVENT_CONST(KEY_MODIFIER_SHIFT);
	KEY_EVENT_CONST(KEY_MODIFIER_ALT);
	KEY_EVENT_CONST(KEY_MODIFIER_SUPER);
#undef KEY_EVENT_CONST
...
#define CONST(n) krk_attachNamedValue(&module->fields, #n, INTEGER_VAL(n))
	...
	CONST(YUTANI_WINDOW_FLAG_NO_STEAL_FOCUS);
	CONST(YUTANI_WINDOW_FLAG_DISALLOW_DRAG);
	CONST(YUTANI_WINDOW_FLAG_DISALLOW_RESIZE);
	CONST(YUTANI_WINDOW_FLAG_ALT_ANIMATION);
	CONST(YUTANI_WINDOW_FLAG_DIALOG_ANIMATION);
	CONST(YUTANI_WINDOW_FLAG_NO_ANIMATION);
	CONST(YUTANI_WINDOW_FLAG_BLUR_BEHIND);
	CONST(YUTANI_WINDOW_FLAG_PARENT_WID);

	CONST(YUTANI_CURSOR_TYPE_RESET);
	CONST(YUTANI_CURSOR_TYPE_HIDE);
	CONST(YUTANI_CURSOR_TYPE_NORMAL);
	CONST(YUTANI_CURSOR_TYPE_DRAG);
	CONST(YUTANI_CURSOR_TYPE_RESIZE_VERTICAL);
	CONST(YUTANI_CURSOR_TYPE_RESIZE_HORIZONTAL);
	CONST(YUTANI_CURSOR_TYPE_RESIZE_UP_DOWN);
	CONST(YUTANI_CURSOR_TYPE_RESIZE_DOWN_UP);
	CONST(YUTANI_CURSOR_TYPE_POINT);
	CONST(YUTANI_CURSOR_TYPE_IBEAM);

	CONST(YUTANI_SHAPE_THRESHOLD_NONE);
	CONST(YUTANI_SHAPE_THRESHOLD_CLEAR);
	CONST(YUTANI_SHAPE_THRESHOLD_HALF);
	CONST(YUTANI_SHAPE_THRESHOLD_ANY);
	CONST(YUTANI_SHAPE_THRESHOLD_PASSTHROUGH);
	...
	CONST(YUTANI_SPECIAL_REQUEST_MAXIMIZE);
	CONST(YUTANI_SPECIAL_REQUEST_PLEASE_CLOSE);
	CONST(YUTANI_SPECIAL_REQUEST_MINIMIZE);
	CONST(YUTANI_SPECIAL_REQUEST_CLIPBOARD);
	CONST(YUTANI_SPECIAL_REQUEST_RELOAD);

	CONST(YUTANI_RESIZE_NORMAL);
	CONST(YUTANI_RESIZE_TILED);
	CONST(YUTANI_RESIZE_TILE_LEFT);
	CONST(YUTANI_RESIZE_TILE_RIGHT);
	CONST(YUTANI_RESIZE_TILE_UP);
	CONST(YUTANI_RESIZE_TILE_DOWN);

	CONST(YUTANI_BLUR_REQUEST_SET_MODE);
	CONST(YUTANI_BLUR_REQUEST_SET_SIZE);
	CONST(YUTANI_BLUR_REQUEST_SET_PASSES);
	CONST(YUTANI_BLUR_REQUEST_NO_FLIP);

	CONST(YUTANI_BLUR_MODE_OFF);
	CONST(YUTANI_BLUR_MODE_STANDARD);
	CONST(YUTANI_BLUR_MODE_SUBTLE);
	CONST(YUTANI_BLUR_MODE_CUSTOM);
	CONST(YUTANI_BLUR_MODE_SCALED);
#undef CONST
