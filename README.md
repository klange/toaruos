...
![Screenshot](https://i.imgur.com/ZovFcMe.png)
...
The current release series is 1.8.x, which aims to eventually replace all third-party elements of the build process and make the OS fully self-hosting.
