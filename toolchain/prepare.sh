...
pushd "$DIR" > /dev/null
    ...
    pushd tarballs > /dev/null
        ...
        grab "gcc"  "http://www.netgull.com/gcc/releases/gcc-4.6.4" "gcc-core-4.6.4.tar.gz"
        grab "g++"  "http://www.netgull.com/gcc/releases/gcc-4.6.4" "gcc-g++-4.6.4.tar.gz"
        ...
        deco "gcc"  "gcc-core-4.6.4.tar.gz"
        deco "g++"  "gcc-g++-4.6.4.tar.gz"
